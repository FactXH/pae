-- =====================================================
-- Climate Survey 2025 Answers Base Model
-- =====================================================
-- This model extracts and joins survey form data with question groups,
-- question configurations, and custom field values for Climate Survey 2025
-- =====================================================
...
With 
        ...
        -- Filter for Climate Survey 2025 (id = 233598)
        climate_survey_2025 as (
        Select sf.*
