...
from b2
Left Join data_lake_gold.employees em ON em.access_id = b2.question_respondent_access_id 
Left Join memberships_ m On m.employee_id = em.employee_id
Left join teams_ t On t.id = m.team_id
